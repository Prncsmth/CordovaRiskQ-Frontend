...
- [ ] Responder incident detail ([id].tsx): handleJoin's error path calls router.back() immediately after Alert.alert(), popping the screen before the user dismisses the alert
